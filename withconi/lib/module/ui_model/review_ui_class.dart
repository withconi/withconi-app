...
abstract class ReviewUIClassImpl {
  // late final List<ReviewItems> reviewItems;
  late final int reviewNum;
  late final Map<ReviewItems, int> reviewItemsMap;
  ...
  late List<ReviewItems> selectedReviewItems;
}

class HighReviewUIClass implements ReviewUIClassImpl {
  @override
  int reviewNum = 0;
  ...
  @override
  Map<ReviewItems, int> reviewItemsMap = {
  ...
  HighReviewUIClass({required this.selectedReviewItems});
...
class MiddleReviewUIClass implements ReviewUIClassImpl {
  @override
  int reviewNum = 0;
  ...
  MiddleReviewUIClass({required this.selectedReviewItems});
  @override
  String Function(ReviewItems reviewItem) reviewItemsToString = (reviewItem) {
    switch (reviewItem) {
      case ReviewItems.explanation:
...
class LowReviewUIClass implements ReviewUIClassImpl {
  @override
  int reviewNum = 0;
  ...
  @override
  List<ReviewItems> selectedReviewItems = [];
  LowReviewUIClass({required this.selectedReviewItems});
  @override
  String Function(ReviewItems reviewItem) reviewItemsToString = (reviewItem) {
    switch (reviewItem) {
      case ReviewItems.explanation:
