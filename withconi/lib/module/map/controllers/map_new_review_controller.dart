...
class MapNewReviewController extends GetxController {
  MapNewReviewController(this._mapRepository);
  final MapRepository _mapRepository;

  final int maxImageNum = 4;
  final RxInt selectedImageNum = 0.obs;
  final RxList<File> imageFileList = <File>[].obs;
  late Rx<PlacePreviewUiModel> selectedPlacePreview;
  // late Rx<ReviewDetailUIModel> newReview;
  ...
  _initPlaceToReview() async {
    ...
    selectedPlacePreview =
        Rx<PlacePreviewUiModel>(Get.arguments as PlacePreviewUiModel);
    isLoading.value = false;
  }

  onPlaceChanged(PlacePreviewUiModel? placePreview) async {
    if (placePreview != null) {
      selectedPlacePreview.value = placePreview;
      selectedPlacePreview.refresh();
    }
  }
  ...
  ReviewDetailUIModel _makeNewReviewModel() {
    return ReviewDetailUIModel(
        ...
        placePreview: selectedPlacePreview.value,
        reviewDesc: '');
  }
}
