...
import '../../../controller/signup/signup_conimal_step1_controller.dart';
...
class SignupPageConimalStep1 extends StatelessWidget {
  SignupPageConimalStep1({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    SignupConimalStep1Controller _controller =
        Get.put(SignupConimalStep1Controller());
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Obx(
                  () => AnimatedOpacity(
                    curve: Curves.easeIn,
                    opacity: _controller.showAddConimalButton.value ? 1.0 : 00,
