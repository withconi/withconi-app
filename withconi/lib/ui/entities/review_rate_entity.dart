...
class HighReviewEntity implements ReviewEntity {
  @override
  int reviewNum = 0;
  ...
  HighReviewEntity({required this.selectedReviewItems});
...
class MiddleReviewEntity implements ReviewEntity {
  @override
  int reviewNum = 0;
  ...
  MiddleReviewEntity({required this.selectedReviewItems});
  @override
  String Function(ReviewItems reviewItem) reviewItemsToString = (reviewItem) {
    switch (reviewItem) {
      case ReviewItems.explanation:
...
class LowReviewEntity implements ReviewEntity {
  @override
  int reviewNum = 0;
  ...
  @override
  List<ReviewItems> selectedReviewItems = [];
  LowReviewEntity({required this.selectedReviewItems});
  @override
  String Function(ReviewItems reviewItem) reviewItemsToString = (reviewItem) {
    switch (reviewItem) {
      case ReviewItems.explanation:
